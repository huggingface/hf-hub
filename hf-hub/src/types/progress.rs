...
//! use std::sync::Arc;
//!
//! use hf_hub::types::{DownloadEvent, Progress, ProgressEvent, ProgressHandler, UploadEvent};
//!
//! struct PrintHandler;
//!
...
///
/// use hf_hub::types::{ProgressEvent, ProgressHandler, UploadEvent};
///
/// struct ByteCounter {
///     bytes: AtomicU64,
/// }
...
/// use std::sync::Arc;
///
/// use hf_hub::types::{Progress, ProgressEvent, ProgressHandler};
///
/// struct Noop;
